...
export function AuthService($location, $http, $cookies, $q, appConfig, Util, User) {
  ...
  var Auth = {
    ...
    createUser(user, callback) {
      ...
      return User.save(user, function(data) {
        if(user.role=='organisation'){
          currentUser = new _User;
          return safeCb(callback)(null, null);
        }
        else{
    ...
    isOrganisation(){
      ...
      return Auth.hasRole.apply(Auth, [].concat.apply(['organisation'], arguments));
    },
    /**
     * Check if a user is an admin
     *
    ...
    isOrganisationSync() {
      console.log("Organisation Synced");
      return Auth.hasRoleSync('organisation');
    },
